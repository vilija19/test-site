...
class ProductCreateView implements \Vilija19\Core\Interfaces\RenderInterface
{
    ...
    public function render()
    {
        ...
        $view .= '                <div class="col-sm-3">'.PHP_EOL;
        $view .= '                    <input type="text" placeholder="Please, provide size" class="form-control required" id="size" name="attributes[size]">'.PHP_EOL;
        $view .= '                </div>'.PHP_EOL;
        $view .= '              </div>'.PHP_EOL;
        ...
        $view .= '                <div class="col-sm-3">'.PHP_EOL;
        $view .= '                    <input type="text" placeholder="Please, provide height" class="form-control required" id="height" name="attributes[dimensions][height]">'.PHP_EOL;
        $view .= '                </div>'.PHP_EOL;
        $view .= '              </div>'.PHP_EOL;
        $view .= '              <div class="row mb-3">'.PHP_EOL;
        $view .= '                <label for="width" class="col-sm-2 col-form-label">Width (CM)</label>'.PHP_EOL;
        $view .= '                <div class="col-sm-3">'.PHP_EOL;
        $view .= '                    <input type="text" placeholder="Please, provide weight" class="form-control required" id="width" name="attributes[dimensions][width]">'.PHP_EOL;
        $view .= '                </div>'.PHP_EOL; 
        $view .= '              </div>'.PHP_EOL;
        $view .= '              <div class="row mb-3">'.PHP_EOL;
        $view .= '                <label for="length" class="col-sm-2 col-form-label">Length (CM)</label>'.PHP_EOL;
        $view .= '                <div class="col-sm-3">'.PHP_EOL;
        $view .= '                    <input type="text" placeholder="Please, provide length" class="form-control required" id="length" name="attributes[dimensions][length]">'.PHP_EOL;
        $view .= '                </div>'.PHP_EOL;
        $view .= '              </div>'.PHP_EOL;
        $view .= '              <div class="row mb-3"> *Product Description*</div>'.PHP_EOL;
        $view .= '            </div>'.PHP_EOL;              
        ...
        $view .= '                <div class="col-sm-3">'.PHP_EOL;
        $view .= '                    <input type="text" placeholder="Please, provide weight" class="form-control required" id="weight" name="attributes[weight]">'.PHP_EOL;
        $view .= '                </div>'.PHP_EOL;
        $view .= '              </div>'.PHP_EOL;
